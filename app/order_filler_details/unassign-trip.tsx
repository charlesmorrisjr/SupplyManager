...
export default function UnassignTripDialog({ tripID, casesPicked, employeeID }: { tripID: string, casesPicked: number, employeeID: number }) {
  ...
  const handleUpdateData = async () => {
    ...
    mutate([ '/api/employee_details', parseDate(tripInfo.date), employeeID ])
